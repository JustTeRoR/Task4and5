...
namespace VisualLib.Elements
{
    public class RocketUI : ElementUI<Rocket>
    {
        ...
        int Delta = 150;
        Image icon = Image.FromFile(@"C:\2 курс\ЯиСП\Task-4and5\Task4\Resources\rocket.png");
        Image iconBroken = Image.FromFile(@"C:\2 курс\ЯиСП\Task-4and5\Task4\Resources\rocketBroken.png");
