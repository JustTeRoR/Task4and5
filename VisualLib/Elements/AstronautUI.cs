...
namespace VisualLib.Elements
{
    public class AstronautUI : ElementUI<Astronaut>
    {
        ...
        public Image icon = Image.FromFile(@"C:\2 курс\ЯиСП\Task-4and5\Task4\Resources\astronaut.png");
        public Image iconSucceed = Image.FromFile(@"C:\2 курс\ЯиСП\Task-4and5\Task4\Resources\astronautSuceeded.png");
