...
namespace VisualLib.Elements
{
    public class AgentUI : ElementUI<Agent>
    {
        ...
        Image icon = Image.FromFile(@"C:\2 курс\ЯиСП\Task-4and5\Task4\Resources\agent.png");
        Image iconPaying = Image.FromFile(@"C:\2 курс\ЯиСП\Task-4and5\Task4\Resources\agentMoney.png");
